...
class Auth extends React.Component {
    ...
    submittHandler = (event) => { event.preventDefault() }
            ...
            <div className={styles.Auth}>
                <div>
                    ...
                    <form onSubmit={this.submittHandler} className={styles.AuthForm} >
                        ...
                        <Button type='primary' onClick={this.registernHandler} disabled={!this.state.isFormValid}>Register</Button>
                    </form>
                </div>
            </div>
        )
...
function mapDispatchToProps(dispatch) {
    return {
        auth: (email, password, iaLogin) => dispatch(auth(email, password, iaLogin))
    }
}
